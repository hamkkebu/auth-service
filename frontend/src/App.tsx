...
import LeaveUser from '@/components/views/LeaveUser';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // StrictMode 이중 호출 방지 (useRef는 리렌더 사이에 유지됨)
  ...
  // keycloak.isInitialized 상태가 변경되면 authReady도 업데이트
  useEffect(() => {
    if (keycloak.isInitialized) {
      setAuthReady(true);
    }
  ...
  return (
    <div id="auth-app">
      <Routes>
        ...
        <Route path="leave" element={<LeaveUser />} />
